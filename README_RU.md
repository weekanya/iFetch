...
- проверка Jailbreak Health с предупреждениями;
...
В версии 3.0 появился дополнительный модуль iFetch с CPU, ОЗУ, скоростью сети и
температурой батареи. Для добавления модуля в Control Center рекомендуется
CCSupport.
