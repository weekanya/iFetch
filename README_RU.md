...
- мониторинг CPU, ОЗУ, хранилища, батареи, температуры, термального статуса и сети;
- интерфейс на Swift с визуальным стилем, вдохновлённым iOS 18;
- аппаратная диагностика динамиков (верхний разговорный, нижний и стерео) с генератором частот;
- диспетчер процессов с приоритетами Jetsam, лимитами памяти, информацией о твиках и завершением процесса;
- мониторинг термального состояния SoC и троттлинга с проверкой здоровья системы;
- экспорт полного системного отчёта диагностики в один клик (Markdown/JSON) для отправки разработчикам;
